...
local config = {
        ...
        plugins = {
                                ...
                                textobjects = {
                                        ...
                                        lsp_interop = {
                                                ...
                                                peek_definition_code = {
                                                        ["<leader>lp"] = { query = "@function.outer", desc =
                                                        "Peek function definition" },
                                                        ["<leader>lP"] = { query = "@class.outer", desc =
                ...
                -- custom plugins
                {
                        "catppuccin/nvim", -- pretty dark color scheme
                        as = "catppuccin",
                        config = function()
                ...
                {
                        "chentoast/marks.nvim", -- show the marks in the gutter
                        lazy = false,
                        config = function()
                                require("marks").setup()
                        end,
