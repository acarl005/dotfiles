...
sudo apt-get install --ignore-missing -y git ack autojump ranger tldr curl xclip shellcheck neofetch bat fzf fd-find zsh neovim jq libimage-exiftool-perl
